...
function pageState(configPatch: Partial<ReturnType<typeof loadConfig>> = {}): LocalInferencePageStateDto {
  ...
  return {
    ...
    config: {
      ...
      aiThinkingLevel: config.aiThinkingLevel ?? "",
      aiServiceTier: config.aiServiceTier ?? "auto",
      ...
      fastAiThinkingLevel: config.fastAiThinkingLevel ?? "",
      fastAiServiceTier: config.fastAiServiceTier ?? "auto",
      sandboxProvider: config.sandboxProvider,
      sandboxImage: config.sandboxImage,
      sandboxImageLabel: config.sandboxImageLabel ?? config.sandboxImage,
      sandboxImageSelection: config.sandboxImageSelection ?? { kind: "internal", id: "aithy-sandbox" },
      customSandboxImages: config.customSandboxImages ?? [],
      sandboxImageOptions: config.sandboxImageOptions ?? [],
      sandboxHealth: null,
