...
export const settingsInput = z.object({
  runtime: z.object({
    ...
    aiProfileArgs: z.record(z.string(), z.string().max(500)).optional(),
    aiThinkingLevel: z.enum(["none", "minimal", "low", "medium", "high", "highest"]).optional().nullable(),
    aiServiceTier: z.enum(["auto", "standard", "flex", "priority"]).optional(),
    ...
    fastAiProfileArgs: z.record(z.string(), z.string().max(500)).optional(),
    fastAiThinkingLevel: z.enum(["none", "minimal", "low", "medium", "high", "highest"]).optional().nullable(),
    fastAiServiceTier: z.enum(["auto", "standard", "flex", "priority"]).optional(),
    aiProviderProfiles: z.record(z.string(), z.object({
      ...
      profileArgs: z.record(z.string(), z.string().max(500)).optional(),
      thinkingLevel: z.enum(["none", "minimal", "low", "medium", "high", "highest"]).optional().nullable(),
      ...
      fastProfileArgs: z.record(z.string(), z.string().max(500)).optional(),
      fastThinkingLevel: z.enum(["none", "minimal", "low", "medium", "high", "highest"]).optional().nullable(),
      fastServiceTier: z.enum(["auto", "standard", "flex", "priority"]).optional(),
